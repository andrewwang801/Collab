...
extension DatingHostViewController: ATCDatingProfileEditManagerDelegate {
    func profileEditManager(_ manager: ATCDatingProfileEditManager, didFetch datingProfile: ATCDatingProfile) -> Void {
        ...
        if datingProfile.gender == nil
            ...
            let alertVC = UIAlertController(title: "Let's complete your collaboration profile".localizedInApp,
                                            message: "Welcome to Collab. Let's complete your collaboration profile to allow other people to express interest in you.".localizedInApp,
